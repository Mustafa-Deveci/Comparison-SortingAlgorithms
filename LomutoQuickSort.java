...
public class LomutoQuickSort {
	...
	public int partition(int[] arr, int low, int high) {
	  ...
	  public void hoareQuickSort(int[] arr, int low, int high) {
	...
	public void run() {
		...
		System.out.println();
		System.out.println("****** >>>>>> Lomuto Quick Sort Running <<<<<< ******");
		System.out.println();
		...
		System.out.println();
		System.out.println("****** >>>>>> Lomuto Quick Sort Completed <<<<<< ******");
		System.out.println();
	...
	private double calculateTime(int[] runningArray) {
		...
		this.hoareQuickSort(runningArray, 0, runningArray.length - 1);
